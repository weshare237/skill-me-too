...
import loginStory from '../assets/login.svg'
                ...
                <div>
                  <div className='flex items-center justify-between'>
                    ...
                    <Link
                      to='/forgot-password'
                      title=''
                      className='text-sm font-medium text-green-400 transition-all duration-200 hover:text-green-700 focus:text-green-700 hover:underline'
                    >
                      {' '}
                      Forgot password?{' '}
                    </Link>
                  ...
                  <div className='mt-2.5 relative text-gray-400 focus-within:text-gray-600'>
                    ...
                    <input
                      ...
                      className='block w-full py-4 pl-10 pr-4 text-black placeholder-gray-500 transition-all duration-200 border border-gray-200 rounded-md bg-gray-50 focus:outline-none focus:border-green-400 focus:bg-white caret-green-400'
                    />
                  </div>
                </div>
